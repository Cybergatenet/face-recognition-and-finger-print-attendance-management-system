...
<head>
  ...
  <title>Bio-Metrics Authentocation</title>
...
<!--       <a href="index.php" class="navbar-brand">
        <span class="brand-text font-weight-light">MOUAU</span>
      </a> -->
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="../face/index.html" class="nav-link"><i class="nav-icon fas fa-camera"></i> Bio-Metrics</a>
          </li>
        </ul>
      </div>
